...
mod tests {
    ...
    fn test_validator_full_dsl() {
        ...
        obj.as_object_mut()
            .unwrap()
            .insert("age".to_string(), Value::Int(25));
        obj.as_object_mut()
            .unwrap()
            .insert("score".to_string(), Value::Float(85.5));
        obj.as_object_mut()
            .unwrap()
        ...
        obj.as_object_mut()
            .unwrap()
            .insert("id".to_string(), Value::Int(101));
        ...
        contact.as_object_mut().unwrap().insert(
            "email".to_string(),
        ...
        profile
            .as_object_mut()
            .unwrap()
            .insert("contact".to_string(), contact);
        obj.as_object_mut()
            .unwrap()
        ...
        // 默认值填充
        assert_eq!(
            obj.as_object().unwrap().get("distance"),
        ...
        bad_regex.as_object_mut().unwrap().insert(
            "username".to_string(),
